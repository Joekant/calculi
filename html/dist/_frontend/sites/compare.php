      <div class="row">
        <div class="large-12 columns half-padding text-center">
          <h1 id="headline">Bewerber vergleichen</h1>
          <h2 class="subline">Die Quahl der Wahl...</h2>
        </div>
      </div>
      ...
      <div id="container-compare">
        <div class="box">
          ...
          <div class="value">
            ...
            6<br />
            2450€<br />
            <span class="green-font">93%</span><br />
          </div>
        </div>
...
<div class="text-center half-padding">
  <a href="" class="button red-bg">Ausschreibung beenden</a>
</div>
