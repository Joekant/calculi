  <div class="main-section">
   ...
   <div class="row half-padding">
    <div class="medium-4 columns">
      ...
      <input type="text" id="remail" placeholder="Gastronomie">
    </div>
  ...
  <div class="row padding-bottom">
    ...
    <table>
      <tr>
        ...
        <th width="160px"><i class="fa fa-wrench fa-fw"></i></th>
        <th width="100px"><i class="fa fa-compass fa-fw"></i></th>
        <th width="50px"><i class="fa fa-dashboard fa-fw"></i></th>
        <th width="50px"><i class="fa fa-users fa-fw"></i></th>
        <th width="100px"><i class="fa fa-clock-o fa-fw"></i></th>
        <th width="80px"><i class="fa fa-heart fa-fw"></i></th>
        
      </tr>
      
      <tr class="clickable" onclick="window.document.location='index.php?page=ausschreibungen_detail';">
        <td>T-mobile GmbH</td>
        <td>Kommunikation</td>
        <td>Wien</td>
        <td>96</td>
        ...
        <td><span class="label green-bg">beworben</span></td>      
