...
<div class="row">
  <div class="large-10 columns">
    <h3 class="left">Motivationsschreiben</h3>
    <textarea type="text" id="t_application" name="t_application" rows="5" >Ich möchte mich gerne für diesen Auftrag bewerben, weil...</textarea>
  </div>
  <div class="large-2 columns">
    <h3>Preis</h3>
    <input type="text" class="application-price" id="i_price" name="i_price" placeholder="1800" ><br />
  </div>
</div>
<br class="half-padding">
<div class="row">
