<div id="container-profile"> 
  <div class="row">
    ...
    <div id="profile-body">
      <div class="row">
        <div class="medium-4 columns" id="ratings">
          <h2>Bewertung</h2>
          <div id="points">
            <ul>
              <li class="green-bg w9">9</li>
        ...
        <div class="medium-8 columns" id="references">
          <h2>Referenzen</h2>
          <ul>
            <li><span>2014</span><a href="">http://www.projekt.at</a></li>
            <li><span>2014</span><a href="">http://www.projekt.at</a></li>
            <li><span>2014</span><a href="">http://www.projekt.at</a></li>
            <li><span>2014</span><a href="">http://www.projekt.at</a></li>
            <li><span>2014</span><a href="">http://www.projekt.at</a></li>
    ...
    <div id="profile-statistics" class="dark-bg text-center">
      <div class="row">
