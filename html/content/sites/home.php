<main> 
      ...
      <div class="row margin-top">
        <div class="large-6 columns">
          <h2 class="primary-color-font">Was macht Calculi?</h2>
          <h3 class="freestyle">Die Funktionen im Überblick</h3>
          ...
          proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
          <br />
          <a href=""><em>... mehr erfahren</em></a>

        </div>
        <div class="large-6 columns">
          <img src="img/poster.png" id="poster-img" alt=""/>
        </div>
      </div>
