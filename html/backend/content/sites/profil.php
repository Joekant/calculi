	...
	<!-- 							<dd><a href="#panel4"><i class="fa fa-legal fa-fw"></i></a></dd>
								<dd><a href="#panel5"><i class="fa fa-comments fa-fw"></i></a></dd> -->
							</dl>
						</div>	
					</div>	
					<div class="profile-settings medium-10 columns">		
...
<div id="add-education" class="reveal-modal" data-reveal>
  ...
  <a href="" class="button green-bg text-right"><i class="fa fa-save fa-fw"></i> Speichern</a>
							...
							<div class="content" id="panel3">
							    ...
							    <div id="profile-references" class="row text-center">
							    ...
							    <div class="medium-4 columns reference-item">
							      <a href="" data-reveal-id="add-reference" class="overlay">
